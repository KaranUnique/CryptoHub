...
export const API_CONFIG = {
  // ─── Rate Limiting ──────────────────────────────────────────────
  RATE_LIMIT: {
    MAX_REQUESTS_PER_MINUTE: 15, // More conservative — well below free tier limits
    MAX_CONCURRENT: 2, // Max simultaneous in-flight requests
    MIN_INTERVAL: 4000, // ~4s between dispatches (60000ms / 15 reqs)
  },
